  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="p-6 max-w-2xl w-full">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Import Entry from JSON</h2>
        <p className="text-gray-600 mb-4">
          Paste the JSON text generated by GPT or any other source to prefill the entry form.
        </p>
